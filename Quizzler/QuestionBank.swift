...
//  Quizzler
//
//  Created by soroush amini araste on 12/3/18.
...
class QuestionBank {
    ...
    init() {
        ...
        list.append(Question(text: "sajjad o pashe nish zade?!!", correctAnswer: true))
        list.append(Question(text: "ali kunie ?", correctAnswer: true))
        list.append(Question(text: "justin Obie ?", correctAnswer: true))
        list.append(Question(text: "sajjad paresh zehni dare ?", correctAnswer: true))
        list.append(Question(text: "haj ali 25 e ? ", correctAnswer: false))
        list.append(Question(text: "Always barname ??", correctAnswer: true))
